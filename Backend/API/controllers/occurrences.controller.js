...
exports.update = function(req, res) {
    ...
    query = con.query('UPDATE Occurrences SET id_request =?, departure_time=?, n_casualties=?,   n_ingered=?,    location=?,  terrain_state=?,  total_cost=?,  notes=?,cod_occurence where cod_occurence=?', update, function(err, rows,
        fields) {
        console.log(query.sql);
        if (!err) {
